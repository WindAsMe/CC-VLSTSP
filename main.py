...
if __name__ == "__main__":
    ...
    names = ['monalisa', 'sra104815', 'ara238025', 'lra498378', 'lrb744710', 'world']
    Tours = ['monalisa_5759971', 'sra104815_268786', 'ara238025_618817', 'lra498378_2227522',
    ...
    for inst in range(1):
        ...
        for run in range(1):
            ...
            best_fitness, best_tour = hCCGA.hCCGA_exe(cities, knownTour, NIND, Max_iter, func, sub_size=100)
